<template>
  ...
  <p class="pageDescription">
    ...
    quis nostrud exercitation ullamco laboris nisi ut voluptate velit esse
    cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat
    non proident, sunt in culpa qui
  </p>
  <!-- Composante 1vs1 BetChoice -->
  <div
    class="w-52 inline-flex flex-col justify-center items-center gap-2 mt-6 mb-6"
  >
    <div class="w-36 flex flex-col justify-start items-center gap-2">
      <div
        class="justify-start text-gray-500 text-base font-normal font-['Italian_Plate_No2'] leading-snug"
      >
        Winning bet
      </div>
    </div>

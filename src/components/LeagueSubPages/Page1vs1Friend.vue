<template>
  ...
  <div class="mainWrapper centered">
    <OpponentChoice
      ...
      v-if="!isOpponentSelected"
    />
    <ThemeChoice1vs1 v-if="isOpponentSelected && !isThemeSelected " v-model:isThemeSelected="isThemeSelected" />
    <BetChoice1vs1 v-if="isThemeSelected "/>
